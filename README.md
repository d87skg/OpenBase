...
**The Open Protocol Stack for Trusted AI Agent Interoperability.**
...
OpenBase defines the **standard for AI agent execution evidence** — what gets recorded, how it's verified, and how trust is certified.

- **OBS (OpenBase Event Specification)**: 23 standard event types — the common language for agent actions
- **Evidence Protocol**: SHA-256 hash chain + Ed25519 signatures — tamper-proof execution records
- **Replay Engine**: 4-level fidelity replay — reconstruct what happened and why
- **Conformance**: Certification badges — prove your agent is trustworthy
...
Framework / Runtime (LangGraph, OpenAI, Claude, CrewAI, OpenClaw)
    │
Traccia Adoption Layer (install → intercept → evidence)
    │
OpenBase Protocol (OBS → Evidence → Replay → Conformance)
    │
Trust Layer (Certificate → Governance → Compliance) [future]
Governance
