...
base = r'D:\OpenBase'
conf_dir = os.path.join(base, 'conformance', 'identity')
fixtures_dir = os.path.join(conf_dir, 'fixtures')
os.makedirs(fixtures_dir, exist_ok=True)

# --- Fixtures ---
fixtures = {
    "valid_agent_identity.json": {
    ...
    "deprecated_identity.json": {
        "id": "agent.legacy.bot",
        "type": "agent",
        "display_name": "Legacy Bot",
        "public_key": "ed25519:dGVzdF9sZWdhY3lfcHVibGljX2tleV9kYXRhX2hlcmVfdGVzdA==",
        "status": "deprecated",
...
'''
with open(os.path.join(conf_dir, 'test_identity_schema.py'), 'w', encoding='utf-8') as f:
    f.write(test_code)
