...
base = r'D:\OpenBase'
conf_dir = os.path.join(base, 'conformance', 'transport')
fixtures_dir = os.path.join(conf_dir, 'fixtures')
os.makedirs(fixtures_dir, exist_ok=True)

# --- Fixtures ---
fixtures = {
    "adapter_rest_active.json": {
    ...
    "adapter_error.json": {
        "adapter_id": "adapter-broken-mcp",
        "runtime_name": "broken-runtime",
        "target_protocol": "MCP",
        "endpoint": "http://localhost:9999",
        "auth": {"type": "none"},
        "options": {"auto_emit": False, "batch_size": 1, "retry_max": 0, "timeout_ms": 100},
        "status": "error",
        "created": "2026-07-07T12:00:00Z"
    },
    "sdk_traccia.json": {
...
'''
with open(os.path.join(conf_dir, 'test_transport_schema.py'), 'w', encoding='utf-8') as f:
    f.write(test_code)
